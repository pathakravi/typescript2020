...
/*
7. Mixins
A mixin class is a class that implements a distinct aspect of functionality so that other classes can then include the mixin and access its methods and properties. That way, mixins provide a form of code reuse that is based on composing behavior.
